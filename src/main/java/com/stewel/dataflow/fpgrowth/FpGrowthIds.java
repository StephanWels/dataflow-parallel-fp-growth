...
public class FPGrowthIds {
     ...
     * @throws IOException
     */
    public final void generateTopKFrequentPatterns(Iterator<Pair<ArrayList<Integer>, Long>> transactionStream,
                                                   ArrayList<Long> attributeFrequency,
                                                   long minSupport,
                                                   int k,
                                                   ArrayList<Integer> returnableFeatures) throws IOException {
        ...
        if (returnableFeatures == null || returnableFeatures.isEmpty()) {
            returnableFeatures = new ArrayList<Integer>();
    ...
    private Map<Integer, FrequentPatternMaxHeap> fpGrowth(FPTree tree,
                                                          ...
                                                          int k,
                                                          ArrayList<Integer> requiredFeatures) throws IOException {
    ...
    private Map<Integer, FrequentPatternMaxHeap> generateTopKFrequentPatterns(
            Iterator<Pair<ArrayList<Integer>, Long>> transactions,
            ArrayList<Long> attributeFrequency,
            long minSupport,
            int k,
            int featureSetSize,
            ArrayList<Integer> returnFeatures) throws IOException {
        ...
        while (transactions.hasNext()) {
            Pair<ArrayList<Integer>, Long> transaction = transactions.next();
            ArrayList<Integer> iArr = transaction.getFirst();
